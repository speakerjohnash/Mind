...
# python3.4 -m mind.legacy.thought_classifier [file_name] [document_column_name] [label_column_name]
# python3.4 -m mind.legacy.thought_classifier data/input/Thoughts.csv Thought Type
